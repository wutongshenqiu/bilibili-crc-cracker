// this file is from https://github.com/bilibili-helper/bilibili-helper/blob/master/src/js/libs/crc32.js

const CRC32_POLY = 0xEDB88320;

class Crc32Engine {
    // previously computed table
    ...
    // aotumatically call when a new instance has been created, similar to __init__ in python
    constructor() {
...
crc_cracker = new Crc32Engine();
console.log(crc_cracker.crack("17"));
